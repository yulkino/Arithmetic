    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_Operations_Settings_SettingsId",
                    column: x => x.SettingsId,
                    principalTable: "Settings",
                    principalColumn: "Id");
            });
        ...
        migrationBuilder.InsertData(
            table: "Operations",
            columns: new[] { "Id", "Name", "SettingsId" },
            values: new object[,]
            {
                { new Guid("3c0ab4b3-789b-4cb6-b80f-32d5feff486b"), "Division", null },
                { new Guid("472fe3a7-b8b6-47fa-b74f-07451cd91bc0"), "Addition", null },
                { new Guid("50d78436-3371-421a-8f20-7490bcd58e3a"), "Subtraction", null },
                { new Guid("e713ccff-8cb3-4437-b8fb-f6b664c0d415"), "Multiplication", null }
            });
