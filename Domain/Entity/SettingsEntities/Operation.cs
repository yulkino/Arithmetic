...
Operation : IEntity
{
    ...
    {
        Id = Guid.Parse("472FE3A7-B8B6-47FA-B74F-07451CD91BC0"),
        Name = "Addition"
    };

    public static readonly Operation Subtraction = new()
    {
        Id = Guid.Parse("50D78436-3371-421A-8F20-7490BCD58E3A"),
        Name = "Subtraction"
    };

    public static readonly Operation Multiplication = new()
    {
        Id = Guid.Parse("E713CCFF-8CB3-4437-B8FB-F6B664C0D415"),
        Name = "Multiplication"
    };

    public static readonly Operation Division = new()
    {
        Id = Guid.Parse("3C0AB4B3-789B-4CB6-B80F-32D5FEFF486B"),
        Name = "Division"
    };
